    ...
    return (
        <section className='mt-10' id='hero'>
            <div className='w-full flex items-center justify-center text-center'>
                <h1 className='text-white bg-fadeGray dark:bg-fadeBlue py-3 px-5 rounded-full font-medium text-lg'>
                    Kumusta! 
            ...
            <div className='flex items-center justify-center mt-10'>
                <p className='text-6xl max-[600px]:text-5xl max-[350px]:text-4xl font-extrabold text-center dark:text-white'>
            ...
            <div className='flex items-center justify-center mt-10'>
                <ul className='flex items-center gap-5'>
                    ...
                    <li className='h-6 w-[1px] border-[1px] border-solid border-darkGray dark:border-gray'></li>
                    <li className='flex flex-row max-[600px]:flex-col gap-2 items-center justify-center max-[600px]:text-center dark:text-gray'>
            ...
            <div className='flex items-center justify-center mt-10 gap-5 p-3'>
                <a href='/Resume.pdf' aria-label='Download resume' className='bg-blue dark:bg-neon px-6 py-2 rounded-full text-xl font-medium flex items-center justify-center gap-2 text-fadeGray dark:text-darkBlue hover:scale-110 transition-all duration-200'>
                    <span>
                        <GrCopy/>
                    </span>
                    Resume
