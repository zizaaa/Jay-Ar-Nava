                ...
                <div className='flex gap-2 w-full items-center max-[500px]:justify-center flex-wrap mt-5'>
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            alt="Jay Ar Nava HTML Developer Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava CSS Developer Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava Javascript Developer Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava Typescript Developer Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava Bootstrap Developer Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava Tailwind CSS Developer Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava React Js Developer Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava Vue Js Developer Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className="min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200"
                            alt="Jay Ar Nava Express Js Developer Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava Node Js Developer Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava MongoDB Developer Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava PostgreSQL Developer Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava Git technology Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava Vscode Tools Skills"
                        />
                    ...
                    <div className='group bg-fadeGray dark:bg-fadeBlue max-[500px]:w-20 max-[500px]:h-20 w-28 h-28 flex min-[500px]:flex-row flex-col items-center justify-center rounded-md overflow-hidden relative'>
                        <img 
                            ...
                            className='min-[500px]:h-14 min-[500px]:w-14 h-10 w-10 min-[500px]:group-hover:translate-x-9 min-[500px]:group-hover:translate-y-9 min-[500px]:group-hover:h-24 min-[500px]:group-hover:w-24 min-[500px]:group-hover:opacity-30 min-[500px]:transition-all min-[500px]:duration-200'
                            alt="Jay Ar Nava NPM Tools Skills"
                        />
